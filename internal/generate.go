...
// StartFile starts a file to generate Go code
...
func SplitOutputFilename(m *StructMapping, goFile string) string {
	baseFilename := getBaseFilename(goFile)

	return baseFilename + "_" + strings.ToLower(m.MappingTypeName) + "_gen.go"
}
